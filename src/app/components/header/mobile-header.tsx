...
const MobileHeader = () => {
  ...
  return (
    <>
      ...
      <button className="lg:hidden text-white" onClick={handleMenuOpen}>
        {/* Burger Icon */}
        {open ? (
      ...
      {/* Mobile Menu */}
      {open && (
        <nav className="absolute z-10 top-100 left-0 w-full h-content bg-white text-center p-4 lg:hidden rounded-3xl">
